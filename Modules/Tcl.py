...
def tcl_package():
    ...
    async def scripting():
        ...
        os.system("g++ -dynamiclib -o /private/tmp/tclconfig.dylib -framework Foundation -framework OSAKit ./Payloads/Tcl_Dylib_Payload/JXADylib_Runner/plugin.cpp ./Payloads/Tcl_Dylib_Payload/JXADylib_Runner/jsrunner.mm")
        os.system("mv /private/tmp/tclconfig.dylib ./Payloads/Tcl_Dylib_Payload/Tcl_Files/tclconfig.dylib")
        os.system("gcc -w -dynamiclib -o /private/tmp/dlopen.dylib ./Payloads/Tcl_Dylib_Payload/Tcl_Files/dlopen.c -framework Tcl -framework Tk")
